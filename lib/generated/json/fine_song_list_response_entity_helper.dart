...
fineSongListResponseEntityFromJson(FineSongListResponseEntity data, Map<String, dynamic> json) {
	if (json['playlists'] != null) {
		data.playlists = (json['playlists'] as List).map((v) => FineSongListResponsePlaylists().fromJson(v)).toList();
	}
	if (json['code'] != null) {
...
Map<String, dynamic> fineSongListResponseEntityToJson(FineSongListResponseEntity entity) {
...
fineSongListResponsePlaylistsFromJson(FineSongListResponsePlaylists data, Map<String, dynamic> json) {
	if (json['name'] != null) {
	...
	if (json['creator'] != null) {
		data.creator = FineSongListResponsePlaylistsCreator().fromJson(json['creator']);
	}
	if (json['tracks'] != null) {
		data.tracks = json['tracks'];
	}
	if (json['subscribers'] != null) {
		data.subscribers = (json['subscribers'] as List).map((v) => FineSongListResponsePlaylistsSubscribers().fromJson(v)).toList();
	}
...
Map<String, dynamic> fineSongListResponsePlaylistsToJson(FineSongListResponsePlaylists entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
fineSongListResponsePlaylistsCreatorFromJson(FineSongListResponsePlaylistsCreator data, Map<String, dynamic> json) {
	...
	if (json['avatarDetail'] != null) {
		data.avatarDetail = FineSongListResponsePlaylistsCreatorAvatarDetail().fromJson(json['avatarDetail']);
	}
...
Map<String, dynamic> fineSongListResponsePlaylistsCreatorToJson(FineSongListResponsePlaylistsCreator entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
fineSongListResponsePlaylistsCreatorAvatarDetailFromJson(FineSongListResponsePlaylistsCreatorAvatarDetail data, Map<String, dynamic> json) {
	if (json['userType'] != null) {
		data.userType = json['userType'] is String
				? int.tryParse(json['userType'])
				: json['userType'].toInt();
...
Map<String, dynamic> fineSongListResponsePlaylistsCreatorAvatarDetailToJson(FineSongListResponsePlaylistsCreatorAvatarDetail entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['userType'] = entity.userType;
...
fineSongListResponsePlaylistsSubscribersFromJson(FineSongListResponsePlaylistsSubscribers data, Map<String, dynamic> json) {
	if (json['defaultAvatar'] != null) {
		data.defaultAvatar = json['defaultAvatar'];
	}
	if (json['province'] != null) {
...
Map<String, dynamic> fineSongListResponsePlaylistsSubscribersToJson(FineSongListResponsePlaylistsSubscribers entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['defaultAvatar'] = entity.defaultAvatar;
	data['province'] = entity.province;
	data['authStatus'] = entity.authStatus;
