...
songListResEntityFromJson(SongListResEntity data, Map<String, dynamic> json) {
	if (json['playlists'] != null) {
		data.playlists = (json['playlists'] as List).map((v) => SongListResPlaylists().fromJson(v)).toList();
	}
	if (json['total'] != null) {
...
Map<String, dynamic> songListResEntityToJson(SongListResEntity entity) {
...
songListResPlaylistsFromJson(SongListResPlaylists data, Map<String, dynamic> json) {
	if (json['name'] != null) {
	...
	if (json['creator'] != null) {
		data.creator = SongListResPlaylistsCreator().fromJson(json['creator']);
	}
	if (json['tracks'] != null) {
		data.tracks = json['tracks'];
	}
	if (json['subscribers'] != null) {
		data.subscribers = (json['subscribers'] as List).map((v) => SongListResPlaylistsSubscribers().fromJson(v)).toList();
	}
...
Map<String, dynamic> songListResPlaylistsToJson(SongListResPlaylists entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
songListResPlaylistsCreatorFromJson(SongListResPlaylistsCreator data, Map<String, dynamic> json) {
	...
	if (json['avatarDetail'] != null) {
		data.avatarDetail = SongListResPlaylistsCreatorAvatarDetail().fromJson(json['avatarDetail']);
	}
	if (json['anchor'] != null) {
...
Map<String, dynamic> songListResPlaylistsCreatorToJson(SongListResPlaylistsCreator entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
songListResPlaylistsCreatorAvatarDetailFromJson(SongListResPlaylistsCreatorAvatarDetail data, Map<String, dynamic> json) {
	if (json['userType'] != null) {
		data.userType = json['userType'] is String
				? int.tryParse(json['userType'])
				: json['userType'].toInt();
...
Map<String, dynamic> songListResPlaylistsCreatorAvatarDetailToJson(SongListResPlaylistsCreatorAvatarDetail entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['userType'] = entity.userType;
...
songListResPlaylistsSubscribersFromJson(SongListResPlaylistsSubscribers data, Map<String, dynamic> json) {
	if (json['defaultAvatar'] != null) {
		data.defaultAvatar = json['defaultAvatar'];
	}
	if (json['province'] != null) {
...
Map<String, dynamic> songListResPlaylistsSubscribersToJson(SongListResPlaylistsSubscribers entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['defaultAvatar'] = entity.defaultAvatar;
	data['province'] = entity.province;
	data['authStatus'] = entity.authStatus;
